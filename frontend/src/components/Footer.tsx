          ...
          <div className="grid grid-cols-2 gap-12 sm:gap-6 sm:grid-cols-3">
            ...
            <div className="flex flex-col gap-2 items-center">
              ...
              <section className="flex justify-center items-center">
                <a
                  href="https://www.instagram.com/zent.repuestos/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group flex justify-center p-2 rounded-md drop-shadow-xl bg-gradient-to-tr from-yellow-400 via-pink-500 to-purple-600 text-white font-semibold hover:translate-y-3 hover:rounded-[50%] transition-all duration-500 hover:from-pink-600 hover:to-purple-800"
                >
                  <svg
